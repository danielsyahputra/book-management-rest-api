...
oatpp::Object<BookDto> BookService::getBookById(const oatpp::Object<BookDto>&dto, const oatpp::provider::ResourceHandle<oatpp::orm::Connection>& connection) {
...
oatpp::Object<PageDto<oatpp::Object<BookDto>>> BookService::getAllBooks(const oatpp::UInt32& offset, const oatpp::UInt32& limit) {
    ...
    auto dbResult = database->getAllBooks(offset, numToFetch);
    OATPP_ASSERT_HTTP(dbResult->isSuccess(), Status::CODE_500, dbResult->getErrorMessage());
